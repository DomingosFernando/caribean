...
<body>
  <section id="hotels" class="section-with-bg wow fadeInUp">
    ...
    <div class="col-md-4 col-sm-4 col-xs-12">
      <div class="contact-icon text-center">
        ...
        <p>
          Ligue: +1 5589 55488 55<br>
          <span>Segunda-Sexta (9am-5pm)</span>
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-4 col-sm-4 col-xs-12">
    <div class="contact-icon text-center">
      ...
      <p>
        Email: caribean@hotel.com<br>
        <span>Web: www.caribean.com</span>
      </p>
    </div>
  </div>
</div>
...
<div class="col-md-6 col-sm-6 col-xs-12">
  <div class="form contact-form">
    <div id="sendmessage"><h4>Sua mensagem será enviada. Obrigado!</h4></div>
    ...
    <form action="" method="post" role="form" class="contactForm">
      ...
      <div class="text-center"><button type="submit" class="btn-primary btn-lg">Enviar</button></div>
    </form>
  </div>
</div>
</div>
