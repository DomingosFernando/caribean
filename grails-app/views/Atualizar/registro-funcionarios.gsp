...
<head>
    ...
    <title>Registrando Funcionario</title>
    ...
    <div class="container">
        <div class="login-content">
            ...
            <div class="login-form">
                <g:uploadForm controller="Funcionario">
                    <g:hiddenField name="id" value="${funcionario.id}" />
                    <div class="form-group">
                        <label>Nome</label>
                        <g:textField name="nome" class="form-control" placeholder="${funcionario.nome}"/>
                    </div>

                    <div class="form-group">
                        <label>Email</label>
                        <g:textField name="email" class="form-control" placeholder="${funcionario.email}"/>
                    </div>

                    <div class="form-group">
                        <label>Senha</label>
                        <g:passwordField name="senha" class="form-control" placeholder="${funcionario.senha}"/>
                    </div>

                    <div class="form-group">
                        <label>Salario</label>
                        <g:textField name="salario" class="form-control" placeholder="${funcionario.salario}"/>
                    </div>

                    <div class="form-group">
                        <label>Estado</label>
                        <g:textField name="estado" class="form-control" placeholder="${funcionario.estado}"/>
                    </div>

                    <div class="form-group">
                        <label>Pais</label>
                        <g:textField name="pais" class="form-control" placeholder="${funcionario.pais}"/>
                    </div>
                    ...
                    <g:actionSubmit value="Atualizar" action="atualizar"
