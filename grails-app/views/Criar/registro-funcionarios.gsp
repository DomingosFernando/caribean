        ...
        <div class="login-content">
            ...
            <div class="login-form">
                <g:uploadForm controller="Funcionario">
                    ...
                    <div class="form-group">
                        <label>Função</label>
                        <g:textField name="funcao" class="form-control" placeholder="Função"/>
                    </div>

                    <div class="form-group">
                        <label>Salario</label>
                        <g:textField name="salario" class="form-control" placeholder="Salario"/>
                    </div>

                    <div class="form-group">
                        <label>Carga Horária</label>
                        <g:textField name="carga_horaria" class="form-control" placeholder="Carga Horária"/>
                    </div>
                        <div class="form-group">
                        <label>Disponibilidade</label>
                        <g:textField name="disponibilidade" class="form-control" placeholder="Disponibilidade"/>
                    </div>
